<%@ include file="../header.jsp" %>
    ...
    <div class="max-w-xl mx-auto">
        ...
        <form action="/utilisateurs/save" method="post"
            class="glass rounded-2xl neon-purple p-6 sm:p-8 space-y-5 sm:space-y-6">
            ...
            <div>
                ...
                <input type="text" name="nom" value="${utilisateur.nom}" required placeholder="Entrez le nom complet"
            ...
            <div>
                ...
                <input type="email" name="email" value="${utilisateur.email}" required placeholder="exemple@email.com"
                    class="w-full rounded-xl px-4 py-3 border" />
            </div>
            ...
            <div>
                ...
                <input type="text" list="roles" name="role" value="${utilisateur.role}" required
                    placeholder="Ex: Organisateur, Client..." class="w-full rounded-xl px-4 py-3 border" />
                <datalist id="roles">
            ...
            <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 pt-4">
                ...
                <a href="/utilisateurs/liste"
                    class="btn-neon-gray text-gray-300 px-8 py-3 rounded-xl font-medium text-center">
