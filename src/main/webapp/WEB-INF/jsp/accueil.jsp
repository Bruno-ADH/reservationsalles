...
<div class="text-center py-10 sm:py-20">
    <h1 class="text-3xl sm:text-5xl font-bold text-white mb-3 neon-text-purple">
        <i class="fa-solid fa-champagne-glasses mr-2 sm:mr-3"></i>ReservaSalles
    </h1>
    <p class="text-base sm:text-lg text-gray-400 mb-10 sm:mb-14 px-4">Plateforme de reservation en ligne de salles de fete</p>

    <div class="grid grid-cols-1 sm:grid-cols-3 gap-5 sm:gap-8 max-w-4xl mx-auto px-2">
        <a href="/salles/liste" class="glass rounded-2xl p-8 sm:p-10 neon-purple hover:scale-105 transition-transform duration-300">
        ...
        <a href="/utilisateurs/liste" class="glass rounded-2xl p-8 sm:p-10 neon-cyan hover:scale-105 transition-transform duration-300">
        ...
        <a href="/reservations/liste" class="glass rounded-2xl p-8 sm:p-10 neon-pink hover:scale-105 transition-transform duration-300">
